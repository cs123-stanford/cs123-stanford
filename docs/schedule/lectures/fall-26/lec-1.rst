...
.. important::
   There is no in-person class on Monday 9/21 because of the holiday. Please watch **both** recorded lectures below before starting :doc:`../../labs/fall-26/lab-1`.

   Our first in-person class is **Monday 9/28 at 3:30 PM in STLC 114**. Lab 1 is due **Wednesday 9/30** (extended because of the holiday).

1. **Course Introduction (Jie Tan):** `CS123 Intro recording <https://drive.google.com/file/d/1MWio6-LL5yNgKWZ3gcPtzen5g3tQC28x/view?usp=sharing>`_
2. **PD Control Lecture (Stuart Bowers):** `ROS2 and PD Control recording <https://drive.google.com/file/d/1mZQh3OcTJdzJplZKwUFeTUSi_FAhciz2/view?usp=sharing>`_
