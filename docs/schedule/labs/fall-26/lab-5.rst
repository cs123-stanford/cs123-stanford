.. TODO(staff): lab numbering shifted for this offering (former lab 6).
...
Congratulations on completing Lab 5! You've successfully implemented a cutting-edge voice-controlled robot system using OpenAI's Realtime API. You are welcomed to expand on the karel api to make Pupper do more complex actions, and build upon this for your final project!